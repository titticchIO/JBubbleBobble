...
/**
 * Singleton class representing the main editor frame in the level editor. It
 * contains panels and buttons to create and modify levels.
 */
public class EditorFrame extends JFrame {
	...
	/**
	 * Private constructor for the singleton pattern. Initializes the editor frame
	 * with necessary panels and buttons.
	 */
	private EditorFrame() {
