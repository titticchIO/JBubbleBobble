						...
						addActionListener(e -> {
							try {
								...
								if (levelData != null) {
									...
									JOptionPane.showMessageDialog(this, "Errore: livello non trovato.", "Errore",
...
//			String levelNumber = JOptionPane.showInputDialog(this, "Inserisci il numero del livello da aprire:");
//
//			if (levelNumber != null && !levelNumber.isEmpty()) {
//				try {
//					int numero = Integer.parseInt(levelNumber);
//					String[][] levelData = LevelLoader.readLevelFile(numero);
//
//					if (levelData != null) {
//						getContentPane().remove(editorPanel); // Rimuovi il pannello esistente
