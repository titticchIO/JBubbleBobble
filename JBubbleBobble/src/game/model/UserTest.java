...
public class UserTest {
	...
	/**
	 * Costruttore privato richiamato dal metodo build del Builder, crea un nuovo
	 * User.
	 * 
	 * @param nickname
	 * @param password
	 ...
	 * @param level
	 */
	private UserTest(String nickname, String password, String avatar, int totGames, int wonGames, int lostGames,
			int level) {
	 ...
	 * 
	 * Non è previsto un getter della password in quanto questa non deve essere
	 * visibile dalle altre classi.
	 */
	...
	/**
	 * Controlla se i valori di nickname e password inseriti sonon coerenti con
	 * quelli dell'utente.
	 * 
	 * @param nickname il nickname inserito dall'utente
	 * @param password la password inserita dall'utente
	 * @return un booleano che è true se la password e l'username inseriti
	 *         conincidono con quelli dell User
	 */
	...
	public static class Builder {
		...
		/**
		 * Costruttore del Builder. E' obbligatoria solo la valorizzazione dei campi
		 * nickname e password.
		 * 
		 * @param nickname
		 * @param password
		...
		public UserTest build() {
			return new UserTest(nickname, password, avatar, totGames, wonGames, lostGames, level);
		}
